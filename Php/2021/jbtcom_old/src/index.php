            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-white" id="texteTitre">
                        ...
                        <span class="my-0 py-0 alert alert-info" role="alert" 
                            style="font-size:0.75em;position:relative;
                            width:fit-content !important;
                            color: white !important; background-color: #db8935 !important; border: none !important;">
                            Nouvelle interface très bientôt !
                        </span>
            ...
            <div class="col-12 col-md-12 col-lg-7
                ...
                <div class="jumbotron">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center text-justify mx-3">
                        ...
                        <img src="img/languages_tools/Microsoft_.NET_logo.svg" 
                            alt="logo .net" class="logoLanguages" title="dotnet">
                        ...
                        <img src="img/languages_tools/Typescript_logo_2020.svg" 
                            alt="typescript" class="logoLanguages" title="typescript">

                        <img src="img/languages_tools/javascript-original.svg" 
                            alt="javascript" class="logoLanguages" title="javascript">

                        <img src="img/languages_tools/Angular_full_color_logo.svg" 
                            alt="logo angular" class="logoLanguages" title="angular">
                        ...
                        <img src="img/languages_tools/microsoft-sql-server-logo-svgrepo-com.svg" 
                            alt="sqlserver" class="logoLanguages" title="sqlserver">
                        ...
                        <img src="img/languages_tools/Microsoft-IIS.svg" 
                            alt="iis" class="logoLanguages" title="iis">
                    ...
                    <a class="d-flex flex-row flex-wrap justify-content-end" 
                        ...
                        <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                            ...
                            mt-3 pt-3">
                                ...
                                <h3>
                                <img src="img/languages_tools/Microsoft_.NET_logo.svg" 
                                    alt="logo .net" class="minilogoLanguages" title="dotnet">
                                <img src="img/languages_tools/__csharp_original_logo_icon_146578.svg"
                                    alt="c#" class="minilogoLanguages" title="c#">
                                </h3>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                            ...
                            mt-3 pt-3">
                                ...
                                <h3>
                                    ...
                                    <img src="img/languages_tools/html5-original-wordmark.svg" 
                                    alt="html5" class="minilogoLanguages" title="html5">
                                    <img src="img/languages_tools/css3-original-wordmark.svg" 
                                    alt="css3" class="minilogoLanguages" title="css3">
                        ...
                        <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                            ...
                            mt-3 pt-3 ">
                                ...
                                <img src="img/languages_tools/__csharp_original_logo_icon_146578.svg"
                                    alt="c#" class="minilogoLanguages" title="c#">
                                <img src="img/languages_tools/Angular_full_color_logo.svg" 
                                alt="logo angular" class="minilogoLanguages" title="angular">
                                <img src="img/languages_tools/Typescript_logo_2020.svg" 
                                    alt="typescript" class="minilogoLanguages" title="typescript">
                                <img src="img/languages_tools/javascript-plain.svg" 
                                    alt="logo_js" class="minilogoLanguages" title="logo_js">
                                <img src="img/languages_tools/html5-original-wordmark.svg" 
                                    alt="html5" class="minilogoLanguages" title="html5">
                    ...
                    <a onclick="prochainement()">
                        <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                            ...
                            mt-3 pt-3">
                                ...
                                <img src="img/languages_tools/Microsoft_.NET_logo.svg" 
                                    alt="logo .net" class="minilogoLanguages" title="dotnet">
                                <img src="img/languages_tools/dotnet_maui.svg" 
                                    alt="logo .net maui" class="minilogoLanguages" title="dotnetmaui">
                                <img src="img/languages_tools/__csharp_original_logo_icon_146578.svg"
                                    alt="c#" class="minilogoLanguages" title="c#">
                                </h3>
                                </p>
